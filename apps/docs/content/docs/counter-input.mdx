...
```scss
.GeckoUICounterInput--size-xl .GeckoUICounterInput__button {
  @apply h-14 w-14;
}

.GeckoUICounterInput--size-xl .GeckoUICounterInput__input {
  @apply h-14 w-24 text-lg;
}

.GeckoUICounterInput--size-xl .GeckoUICounterInput__icon {
  @apply h-6 w-6;
}
```
...
- `GeckoUICounterInput--size-{sm|md|lg}` - Size modifiers
- `GeckoUICounterInput--disabled` - Disabled state
- `GeckoUICounterInput--readonly` - Read-only state
- `GeckoUICounterInput__button` - Increment/decrement buttons
- `GeckoUICounterInput__button--increment` - Plus button
- `GeckoUICounterInput__button--decrement` - Minus button

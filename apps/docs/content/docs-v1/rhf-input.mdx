...
Extends all props from [Input](/v1/docs/input) component plus:
...
**Recommended**: Use [RHFInputGroup](/v1/docs/rhf-input-group) for label + input + error layouts. It automatically detects the RHF input and displays validation errors:
...
Or combine with [RHFError](/v1/docs/rhf-error) component manually:
...
- Inherits all accessibility features from [Input](/v1/docs/input) component
...
- [Input](/v1/docs/input) - Base input component
- [RHFTextarea](/v1/docs/rhf-textarea) - Multi-line text input
- [RHFNumberInput](/v1/docs/rhf-number-input) - Number-only input
- [RHFError](/v1/docs/rhf-error) - Error message display
